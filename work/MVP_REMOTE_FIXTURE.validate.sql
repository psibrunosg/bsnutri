...
-- Fixture sintética mínima para fechar o smoke autenticado do MVP.
-- Credenciais previstas para o deploy publicado:
-- 1. mvp.profissional@teste.com / SenhaMvp123!
-- 2. mvp.recepcao@teste.com / SenhaMvp123!
-- 3. mvp.paciente@teste.com / SenhaMvp123!

-- Limpeza idempotente do pacote sintético.
...
insert into auth.users (
  ...
  (
    ...
    '{"full_name":"Profissional MVP"}'::jsonb,
    now(),
    now()
  ),
  (
...
insert into public.memberships (organization_id, user_id, role, status) values
  ('fb000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'owner', 'active'),
...
select public.review_plan_version(
  'f8000000-0000-0000-0000-000000000001',
  'f7000000-0000-0000-0000-000000000001',
