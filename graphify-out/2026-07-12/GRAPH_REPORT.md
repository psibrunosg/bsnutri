# Graph Report - bsnutri  (2026-07-12)

## Corpus Check
- 31 files · ~14,039 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 273 nodes · 349 edges · 24 communities (22 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0fe13446`
...
### Community 4 - "App.tsx"
Cohesion: 0.14
Nodes (10): react, Anthropometry, App(), Assessment, Patient, Workspace, anonKey, isSupabaseConfigured (+2 more)
...
Cohesion: 0.17
Nodes (21): assertFinite(), assertNonNegative(), calculateTargetProgress(), FoodPortion, mapNutrients(), Meal, MealTotal, NutrientKey (+13 more)
...
### Community 21 - "NutritionWorkspace.tsx"
Cohesion: 0.13
Nodes (19): emptyNutrients(), DraftSummary, EditorDay, mapDraftRows(), PlanDayRow, PlanItemRow, PlanMealRow, PlanRow (+11 more)
...
- **Why does `react` connect `App.tsx` to `plugins`, `NutritionWorkspace.tsx`?**
