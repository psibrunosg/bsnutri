...
insert into public.memberships(organization_id,user_id,role,status) values
 ('22000000-0000-0000-0000-000000000001','12000000-0000-0000-0000-000000000001','nutritionist','active'),
 ('22000000-0000-0000-0000-000000000001','12000000-0000-0000-0000-000000000002','receptionist','active'),
 ('22000000-0000-0000-0000-000000000002','12000000-0000-0000-0000-000000000004','nutritionist','active');
...
insert into public.plan_versions(id,organization_id,plan_id,version_no,created_by,published_at,locked_at) values
 ('62000000-0000-0000-0000-000000000001','22000000-0000-0000-0000-000000000001','52000000-0000-0000-0000-000000000001',1,'12000000-0000-0000-0000-000000000001',now(),now());
...
select lives_ok($$insert into public.appointments(organization_id,patient_id,professional_id,requested_by,status,modality,starts_at,ends_at,reviewed_by,reviewed_at) values('22000000-0000-0000-0000-000000000001','32000000-0000-0000-0000-000000000001','12000000-0000-0000-0000-000000000001','12000000-0000-0000-0000-000000000001','approved','online','2030-01-11 14:00+00','2030-01-11 15:00+00','12000000-0000-0000-0000-000000000001',now())$$,'intervalos adjacentes são permitidos');
...
select is((select count(*)::integer from public.appointments),2,'paciente vê somente suas consultas');
...
select is((select count(*)::integer from public.adherence_alerts),0,'paciente não enxerga alerta clínico gerado');
...
select lives_ok($$select public.review_appointment((select id from public.appointments where status='requested' limit 1),'approved','Confirmada',null)$$,'nutricionista aprova solicitação');
